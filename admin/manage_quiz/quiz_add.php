...
if (isset($_POST['btn_add_quiz_sub']))
 ...
 {
	extract($_POST);
	$query="delete from category where category_id='$selected_course'";
	$r=mysqli_query($con, $query);
	if ($r==true) 
	{
		header("Location:manage_quiz.php");
...
$query="insert into question_test values('','$ques','$option1','$option2','$option3','$option4','$matchedanswer','$course_id')"; //$cat value comes from select name attribute
