      ...
      <div class="inner">                                                  <!--  to zoom in and zoom out effect -->
          ...
          <div class="card-body shadow" style="background-color: #f1f1f1;">
           <!--  <h5 class="card-title"><?php echo $row['course_name']; ?></h5> -->
            ...
            <a href="update_videos.php?video_id=<?php echo $row['video_id'] ?>&course_name=<?php echo $row['course_name'] ?>" class="p-1 text-primary" style="text-decoration: none;">update<i class="fa fa-pencil ml-1"></i></a>
